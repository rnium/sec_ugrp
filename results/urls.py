...
urlpatterns = [
    ...
    path('departments/<str:dept_name>/semester/<str:b64_id>/', views.SemesterView.as_view(), name="view_semester"),
    path('departments/<str:dept_name>/course/<str:b64_id>/', views.CourseView.as_view(), name="view_course"),
    ...
    path('coursesupplemetarydocs/<str:b64_id>/', views.download_supplementarydoc, name="download_supplementarydoc"),
